...
Please take a look at the feedback you got on the abalone figure (go back to Canvas and look in Hypothesis). Decide which aspects of the feedback you find useful, combined with your own thoughts on how to make the figure more effective as an explanatory graph.
...
This should be as simple as copy and pasting the code you used on Monday. You'll need to create a new code block below here (remember how to do that?).
